call compile preprocessFileLineNumbers "node_modules\Enigma-Traffic\Common\Common.sqf";
call compile preprocessFileLineNumbers "node_modules\Enigma-Traffic\Common\Debug.sqf";
...
if (isServer) then {
	call compile preprocessFileLineNumbers "node_modules\Enigma-Traffic\Server\Functions.sqf";
	call compile preprocessFileLineNumbers "node_modules\Enigma-Traffic\ConfigAndStart.sqf";
};

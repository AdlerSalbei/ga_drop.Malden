...
_function = {
    ...
    drawIcon3D ["a3\ui_f\data\gui\Rsc\RscDisplayIntel\azimuth_ca.paa", [1,1,1,1], _pos vectorAdd [0,0,1], 1, 1, 45, format ["%1 (%2m)", _markerDescription, round (player distance _pos)], 1, 0.04, "PuristaMedium"];
};
